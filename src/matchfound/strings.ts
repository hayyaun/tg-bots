...
export const errors = {
  ...
  maxInterestsReached: "❌ شما نمی‌توانید بیشتر از 7 علاقه انتخاب کنید. لطفا ابتدا یکی از علایق فعلی را حذف کنید.",
  minInterestsRequired: "❌ شما باید حداقل 3 علاقه داشته باشید. نمی‌توانید کمتر از 3 علاقه انتخاب کنید.",
...
export const notifications = {
  ...
  profileReminder: (completionScore: number) =>
    ...
    `پروفایل شما ${completionScore}/12 تکمیل شده است.\n\n` +
...
export const profileCompletion = {
  welcome: "🎉 به ربات دوستیابی خوش اومدی!\n\nبرای شروع، باید چند فیلد اجباری رو تکمیل کنی:",
  nextField: (fieldName: string, remaining: number) =>
    `✅ فیلد قبلی ثبت شد!\n\n` +
    `📝 فیلد بعدی: ${fieldName}\n` +
    `(${remaining} فیلد باقی مانده)`,
  allRequiredComplete: "🎉 عالی! تمام فیلدهای اجباری تکمیل شدند!",
  fieldPrompt: {
    username: "🔗 لطفا نام کاربری تلگرام خود را تنظیم کنید و سپس دکمه زیر را بزنید:",
    displayName: "👤 لطفا نام نمایشی خود را ارسال کنید (حداکثر 100 کاراکتر):\n\nبرای لغو: /cancel",
    gender: "⚧️ جنسیت خود را انتخاب کنید:",
    lookingFor: "💝 می‌خواهید چه کسی به شما پیشنهاد شود؟",
    birthDate: "🎂 لطفا تاریخ تولد خود را به فرمت YYYY-MM-DD ارسال کنید (مثال: 1995-05-15):\n\nبرای لغو: /cancel",
    interests: "🎯 لطفا حداقل 3 علاقه انتخاب کنید:",
  },
};
